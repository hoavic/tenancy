<div>
    <x-slot name="title">Cài đặt chung</x-slot>
    <x-slot name="header">Cài đặt chung</x-slot>
...
@livewireStyles()
    ...
    class="">
        <div class="setting-header">
            <button class="tab" :class="{'active' : $wire.tab === 'general'}" wire:click="setTab('general')" >Chung</button>
            <button class="tab" :class="{'active' : $wire.tab === 'website'}" wire:click="setTab('website')" >Website</button>
            <button class="tab" :class="{'active' : $wire.tab === 'shop'}" wire:click="setTab('shop')" >Cửa hàng</button>
            <button class="tab" :class="{'active' : $wire.tab === 'cashier'}" wire:click="setTab('cashier')" >Tính tiền</button>
            <button class="tab" :class="{'active' : $wire.tab === 'warehouse'}" wire:click="setTab('warehouse')" >Tồn kho</button>
            <button class="tab" :class="{'active' : $wire.tab === 'payment'}" wire:click="setTab('payment')" >Thanh toán</button>
        </div>
