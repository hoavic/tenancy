<form wire:submit.prevent="updatePost({{ $post->id }})" method="POST" class="relative">
    ...
    @if ($msg)
        <div class="block m-4 bold bg-blue-600">{{ $msg }}</div> 
    @endif
    ...
    <div class="create-grid">
        ...
        <div class="create-bar bg-white p-4">
            ...
            <div class="create-bar-block">
                ...
                <div class="my-2 grid grid-cols-2 gap-4 items-center">
                    <label for="created_at" class="whitespace-nowrap">Ngày đăng:</label>
                    <input type="text" wire:model="created_at" id="created_at" name="created_at" class="rounded w-full" />
                </div>
                <div class="my-2 grid grid-cols-2 gap-4 items-center">
                    <label for="update_at" class="whitespace-nowrap">Đăng</label>
                    <input type="text" wire:model="update_at" id="update_at" name="update_at" class="rounded w-full" />
                </div>
